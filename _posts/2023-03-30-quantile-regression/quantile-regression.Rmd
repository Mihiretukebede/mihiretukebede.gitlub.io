...
library(pacman)
p_load(dplyr,janitor, ggplot2, quantreg, plotly)
...
```
You can see the OLS and quanitile regression based on the median are identical.But the others are different. 
...
That is all for today. Again I highly recommend watching the video and reading `quantreg` package functions. That is it all for today. I hope, you like it. See you in my next post.
