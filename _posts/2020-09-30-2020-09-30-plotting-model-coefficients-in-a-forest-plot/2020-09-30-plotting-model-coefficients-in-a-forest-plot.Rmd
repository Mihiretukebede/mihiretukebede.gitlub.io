...
```{r, include=TRUE, echo=TRUE, warning=FALSE}
plot_lm + scale_x_discrete(breaks = c("statusDeveloping", "alcohol",
                                    "thinness_1_19_years", 
...
The logistic regression model predicts the data with 83% accuracy. Ideally, we have to split the data into test and train set and perform the performance evaluation using confusion matrix functions.
