...
citation: false
description: |
  In this post I reproduce an elegant JAMA forest plot—originally created in SAS—using R and Python.
ategories: 
  - Data Science
google_analytics: "UA-173027539-1"
preview: foresplotcoverimage.png
...
Let's see this elegant forest plot presented in this article: [Associations Between Diabetes and Incident Colorectal Cancer](https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2811815). It looks nice and easy to read, right? So what is stopping many from presenting regression results like this---clear, visual, and instantly interpretable?
...
Plot in python: we will use the `forestplot` library from python. You can take a look at the [vignettes](https://pypi.org/project/forestplot/) for more details.
