...
baseurl: https://github.com/Mihiretukebede/mihiretukebede.gitlub.io 
collections:
  posts:
    disqus: "animating-scatterplot"
      shortname: "mihiretukebede"
      hidden: false
...
`library(devtools)` ## NB if you don't have the necessary packages, you need to install them with the following codes
