...
```{r}
covid_sars2 <- read.csv("covid_sars.csv",sep=";", encoding="UTF-8")
```
...
SVM prediction is quite remarkable. Almsot 92% accurate prediction. This is cool. Look at the other performance measures: sensitivity, specificity, PVP, NPV, recall, precission. They are all more than 90%!
