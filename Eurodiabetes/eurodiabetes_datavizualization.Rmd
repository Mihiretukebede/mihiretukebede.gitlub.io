...
output_dir: "."
title: "Vizualizing the prevalence of diabetes in five European countries"
author: Mihiretu Kebede (PhD)
url: http://www.mihiretukebede.com/ 
google_analytics: "UA-173027539-1"
date: "`r Sys.Date()`"
description: |
  This is a quick demonstration of diabetes prevalence in five European countries. Tha data are from the IHME. 
...
```{r, layout="l-body-outset", preview=TRUE, include=TRUE, echo=TRUE}
...
euro_anim <- ggplot(ger_au_ch, aes(x=Yearnumeric, y=Prev, col=Location)) + 
  ...
  labs(col="Country") + 
  ggtitle("Prevalence of diabetes cases in five European countries") +
